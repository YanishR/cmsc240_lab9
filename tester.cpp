...
int main ()
{
    ...
    std::cout << "Size: " << intList.size() << "\t[Expected: 3]"<< std::endl;
    ...
    intList.remove(1);
    std::cout << "UdpatedList : " << intList.get(0) << "\t[Expected: 20]" << std::endl;
    std::cout << "Updated Size: " << intList.size() << "\t[Expected: 1]"<< std::endl;
